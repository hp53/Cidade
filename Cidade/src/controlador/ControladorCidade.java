...
public class ControladorCidade {
    ...
    public static void inserir(ManutencaoCidade man){
        ...
        objeto.setDistancia_da_capital(Integer.parseInt(man.jtfDistancia_da_capital.getText()));
...
man.dispose();//fechar a tela da manutenção
  ...
  public static void atualizaCampos(ManutencaoCidade man, int pk){ 
        ...
        man.jtfDistancia_da_capital.setText(objeto.getDistancia_da_capital().toString());
